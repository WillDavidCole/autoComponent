...
(this, (function () {
        ...
        var C,
        k = (C = "undefined" != typeof Uint8Array && c(Uint8Array), function (e) {
            ...
            function l(t, r, o) {
                ...
                if (t && !o && "object" === e(t))
                    if (U.endsWith(r, "{}"))
                        ...
                        (t) || U.isFileList(t) || U.endsWith(r, "[]") && (a = U.toArray(t)))
        ...
        function ie(e) {
            function t(e, n, r, o) {
                ...
                a = Number.isFinite(+i),
                s = o >= e.length;
                return i = !i && U.isArray(r) ? r.length : i,
                s ? (U.hasOwnProp(r, i) ? r[i] = [r[i], n] : r[i] = n, !a) : (r[i] && U.isObject(r[i]) || (r[i] = []), t(e, n, r[i], o) && U.isArray(r[i]) && (r[i] = function (e) {
                        var t,
                        n,
                        r = {},
                        o = Object.keys(e),
        ...
        var Se = {
            ...
            xhr: "undefined" != typeof XMLHttpRequest && function (e) {
                return new Promise((function (t, n) {
                        ...
                        "setRequestHeader" in u && U.forEach(i.toJSON(), (function (e, t) {
        ...
        var Re = function (e) {
            ...
            if (!n) {
                if (!1 === n)
                    throw new F("Adapter ".concat(t, " is not supported by the environment"), "ERR_NOT_SUPPORT");
        ...
        function je(e) {
            ...
            Re(e.adapter || ue.adapter)(e).then((function (t) {
                    ...
                    return ye(t) || (Ae(e), t && t.response && (t.response.data = ve.call(e, e.transformResponse, t.response), t.response.headers = me.from(t.response.headers))),
                    Promise.reject(t)
                }))
        }
        var Te = function (e) {
        ...
        Ce.transitional = function (e, t, n) {
            ...
            return function (n, o, i) {
                if (!1 === e)
                    throw new F(r(o, " has been removed" + (t ? " in " + t : "")), F.ERR_DEPRECATED);
                return t && !ke[o] && (ke[o] = !0, console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))),
                !e || e(n, o, i)
            }
        };
        var Pe = {
            assertOptions: function (t, n, r) {
                ...
                for (var o = Object.keys(t), i = o.length; i-- > 0; ) {
                    ...
                    if (s) {
                        ...
                        c = void 0 === u || s(u, a, t);
                        if (!0 !== c)
                            throw new F("option " + a + " must be " + c, F.ERR_BAD_OPTION_VALUE)
                    } else if (!0 !== r)
        ...
        Be = function () {
            ...
            return r(e, [{
                        ...
                        value: function (e, t) {
                            ...
                            void 0 !== i && Pe.assertOptions(i, {
                                encode: _e.function,
                                serialize: _e.function
                            }, !0),
                            t.method = (t.method || this.defaults.method || "get").toLowerCase(),
                            (n = a && U.merge(a.common, a[t.method])) && U.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function (e) {
                                    delete a[e]
                                })),
